  ...
  const ogMovieData = [
    {
      ...
      rating: 8.8,
      summary:
        "RRR is an upcoming Indian Telugu-language period "
    },
    {
      name: "Iron man 2",
      poster:
    ...
    },
    {
      ...
      rating: 8.1,
      summary:
        "A hunter's life takes a drastic turn when he "
    },
    {
      name: "Jai Bhim",
      poster:
      ...
      summary:
        "A tribal woman and a righteous lawyer battle in court ",
      rating: 8.8
    },
    {
      name: "The Avengers",
      rating: 8,
      summary:
        "Marvel's The Avengers (classified under the name ",
      poster:
    ...
    },
    {
      ...
      rating: 8.6,
      summary:
        "When Earth becomes uninhabitable in the future, a "
    },
    {
      name: "Baahubali",
  ...
  return (
    <div className="App">
      ...
      <div className="moviedatadiv">
        {MovieData.map(nm => <MovieDetail name={nm.name} url={nm.poster} rating={nm.rating} summary={nm.summary} />)}
      </div>
    </div>
  );
}
